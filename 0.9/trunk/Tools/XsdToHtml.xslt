...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <html>
      ...
      <body>
        ...
        <div id="bodyContainer">
          <p/>
          <h1>
            Contract <xsl:value-of select="@targetNamespace"/>
          </h1>
          <p/>
  ...
  <xsl:template match="xs:complexType[xs:all]">
    ...
    <div id="bodyContainer">
      <p/>
      <h1>
        Resource <xsl:value-of select="substring(@name, 0, string-length(@name) - 5)"/>
      </h1>
      <p/>
      <table class="greyBorder" print-width="100%">
        <tr>
  ...
  <xsl:template match="xs:element" mode="property">
    <tr>
      ...
      <td>
        <xsl:choose>
          <xsl:when test="@sme:mandatory = 'true'">
            X
          </xsl:when>
          <xsl:otherwise>
            &#xa0;
  ...
  <xsl:template match="xs:simpleType[xs:restriction/xs:enumeration]">
    ...
    <div id="bodyContainer">
      ...
      <a name="{@name}"/>
      <h1>
        Enumeration <xsl:value-of select="substring(@name, 0, string-length(@name) - 5)"/>
      </h1>
      <p/>
      <table class="greyBorder" print-width="100%">
