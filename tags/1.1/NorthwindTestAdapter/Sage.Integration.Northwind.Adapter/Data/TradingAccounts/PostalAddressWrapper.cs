...
namespace Sage.Integration.Northwind.Adapter.Data
{
    ...
    public class PostalAddressWrapper : EntityWrapperBase, IEntityWrapper, IEntityQueryWrapper
    {
        #region Class Variables

        private ITransformation<AddressDocument, PostalAddressPayload> _transformation;
