...
{
    [RequestPath("commodityGroups", "commodityGroup(<resource>)")]
    public class CommodityGroupRequestReceiver
    {
        ...
        public CommodityGroupRequestReceiver(NorthwindAdapter adapter)
        {
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Post(IRequest request, CommodityGroupFeedEntry entry)
        {
            CRUD crud = new CRUD(request);
            crud.Create(entry);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Put(IRequest request, CommodityGroupFeedEntry entry, string resource)
        {
            CRUD crud = new CRUD(request);
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void PostSyncTarget(IRequest request, Feed<CommodityGroupFeedEntry> feed)
        {
            RequestContext context = new RequestContext(request.Uri);
