...
{
    [RequestPath("commodities", "commodityGroup(<resource>)")]
    public class CommoditiesRequestReceiver
    {
        ...
        public CommoditiesRequestReceiver(NorthwindAdapter adapter)
        {
        ...
        public void GetTemplate(IRequest request)
        {
            ...
            request.Response.FeedEntry = TemplateFactory.GetTemplate<CommodityFeedEntry>(request);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Post(IRequest request, CommodityFeedEntry entry)
        {
            CRUD crud = new CRUD(request);
            crud.Create(entry);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Put(IRequest request, CommodityFeedEntry entry, string resource)
        {
            CRUD crud = new CRUD(request);
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void PostSyncTarget(IRequest request, Feed<CommodityFeedEntry> feed)
        {
            RequestContext context = new RequestContext(request.Uri);
