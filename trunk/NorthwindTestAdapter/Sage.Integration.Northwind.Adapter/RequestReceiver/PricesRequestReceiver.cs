...
{
    [RequestPath("prices", "prices(<resource>)")]
    public class PricesRequestReceiver
    {
        ...
        public PricesRequestReceiver(NorthwindAdapter adapter)
        {
        ...
        public void GetTemplate(IRequest request)
        {
            ...
            request.Response.FeedEntry = TemplateFactory.GetTemplate<PriceFeedEntry>(request);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Post(IRequest request, PriceFeedEntry entry)
        {
            CRUD crud = new CRUD(request);
            crud.Create(entry);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Put(IRequest request, PriceFeedEntry entry, string resource)
        {
            CRUD crud = new CRUD(request);
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void PostSyncTarget(IRequest request, Feed<PriceFeedEntry> feed)
        {
            RequestContext context = new RequestContext(request.Uri);
