...
{
    [RequestPath("emails", "emails(<resource>)")]
    public class EmailsRequestReceiver
    {
        ...
        public EmailsRequestReceiver(NorthwindAdapter adapter)
        {
        ...
        public void GetEmail(IRequest request, string resource)
        {
        ...
        public void GetTemplate(IRequest request)
        {
            ...
            request.Response.FeedEntry = TemplateFactory.GetTemplate<EmailFeedEntry>(request);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void PostEmails(IRequest request, EmailFeedEntry entry)
        {
            CRUD crud = new CRUD(request);
            crud.Create(entry);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void PutEmails(IRequest request, EmailFeedEntry entry, string resource)
        {
            CRUD crud = new CRUD(request);
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void DeleteEmails(IRequest request, string resource)
        {
            CRUD crud = new CRUD(request);
