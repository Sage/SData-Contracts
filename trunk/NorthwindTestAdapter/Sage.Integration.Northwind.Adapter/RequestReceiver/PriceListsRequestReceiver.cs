...
{
    [RequestPath("priceLists", "priceLists(<resource>)")]
    public class PriceListsRequestReceiver
    {
        ...
        public PriceListsRequestReceiver(NorthwindAdapter adapter)
        {
        ...
        public void GetTemplate(IRequest request)
        {
            ...
            request.Response.FeedEntry = TemplateFactory.GetTemplate<PriceListFeedEntry>(request);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Post(IRequest request, PriceListFeedEntry entry)
        {
            CRUD crud = new CRUD(request);
            crud.Create(entry);
        }
        ...
        [SupportedContentType(MediaType.Atom)]
        [SupportedContentType(MediaType.AtomEntry)]
        public void Put(IRequest request, PriceListFeedEntry entry, string resource)
        {
            CRUD crud = new CRUD(request);
