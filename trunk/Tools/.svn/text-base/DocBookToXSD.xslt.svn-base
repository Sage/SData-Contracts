...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="/article">
    ...
    <xs:schema id="crmErp" 
               ...
               targetNamespace="http://schemas.sage.com/crmErp/2008"
               xmlns:hrmErp="http://schemas.sage.com/hrmErp/2008"
               xmlns:sme="http://schemas.sage.com/sdata/sme/2007"
               xmlns:xs="http://www.w3.org/2001/XMLSchema">
      <xs:import namespace="http://schemas.sage.com/hrmErp/2008" />
  ...
  <xsl:template match="sect1/sect2" mode="resourceKinds">
    ...
    <xsl:if test="$name != ''">
      ...
      <xs:complexType name="{$camel}--list">
        <xs:sequence>
          <xs:element name="{$camel}" type="{$camel}--type" minOccurs="0" maxOccurs="unbounded"/>
        </xs:sequence>
      </xs:complexType>
    </xsl:if>
  ...
  <xsl:template match="row">
    ...
    <xsl:variable name="mandatory" select="entry[7]/para = 'True'"/>
    <xsl:variable name="type" select="entry[8]/para"/>
    ...
    <xsl:variable name="comments" select="string(entry[11]/para)"/>
